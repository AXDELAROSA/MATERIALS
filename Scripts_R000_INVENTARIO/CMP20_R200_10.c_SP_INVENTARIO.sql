...
---- // STORED PROCEDURE ---> INSERT
---- //////////////////////////////////////////////////////////////
--IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_IN_INVENTARIO]') AND type in (N'P', N'PC'))
--	DROP PROCEDURE [dbo].[PG_IN_INVENTARIO]
--GO

--CREATE PROCEDURE [dbo].[PG_IN_INVENTARIO]
--	@PP_K_SISTEMA_EXE				INT,
--	@PP_K_USUARIO_ACCION			INT,
--	-- ===========================
--	@PP_K_ITEM								[INT],
